...
const days: Day[] = [
  ...
  { date: 'Sep 4', day: 'Fri · together', theme: 'Samcheong, Bukchon & Hoehyeon', description: 'Serious art, independent galleries, the Es Devlin installation, then a final independent-publishing stop in Hoehyeon.', stops: [{ name: 'MMCA Seoul', korean: '서울 종로구 삼청로 30 국립현대미술관 서울', note: 'Do Ho Suh + conceptual art' }, { name: 'FUTURA SEOUL', korean: '서울 종로구 북촌로 61 푸투라서울', note: 'Es Devlin: Come Home Again', booking: 'https://www.futuraseoul.org/57' }, { name: 'The Book Society Hoehyeon', korean: '서울 중구 퇴계로4길 2 로컬스티치 C동 3층 더북소사이어티', note: 'Finish here for independent art books, publishing and exhibitions' }] },
