...
type StopLink = { label: string; url: string };
type Stop = { name: string; korean: string; note: string; booking?: string; links?: StopLink[]; visited?: boolean };
type Day = { date: string; day: string; theme: string; description: string; stops: Stop[]; options?: Stop[]; must?: string; focus?: string; focusLabel?: string };
...
const days: Day[] = [
  ...
  { date: 'Aug 26', day: 'Wed · Silka', theme: 'Nails & designer second-hand', description: 'Keep it gentle: nails in Myeongdong, then Apgujeong resale browsing.', stops: [{ name: 'Gugus Apgujeong', korean: '서울 강남구 선릉로 846 구구스 압구정점', note: 'Pre-owned luxury' }, { name: 'Mihou’s Nail', korean: '서울 중구 명동', note: 'Message +82 10-5779-0737 on WhatsApp first' }], options: [{ name: 'Kim Heecheon: Moles', korean: '서울 금천구 시흥대로79길 65 서서울미술관', note: 'Free media-art exhibition; open until 20:00 on weekdays', booking: 'https://sema.seoul.go.kr/en/whatson/exhibition/detail?exNo=1565118' }, { name: 'Wanita Listeningroom', korean: '서울 성동구 연무장17길 5 3.5층 와니타음악감상실 성수', note: 'Two-hour LP listening session; ₩15,000 including one drink', booking: 'https://feverup.com/m/420903/en' }, { name: 'entry55 Seongsu — The Entry to Jazz', korean: '서울 성동구 성수일로8길 60 지하1층 엔트리55 성수', note: 'Weekday jazz sets at 19:30 or 21:40; from ₩17,000', booking: 'https://feverup.com/m/645696' }], must: 'Arrange Mihou’s Nail if you want it.' },
  { date: 'Aug 27', day: 'Thu · Silka', theme: 'Open solo day', description: 'Keep this day flexible for work, rest, or an impromptu nearby visit.', stops: [{ name: 'Open solo plan', korean: '서울', note: 'No timed visit planned.' }] },
  { date: 'Aug 28', day: 'Fri · Silka', theme: 'Chris Ro & Yongsan vintage', description: 'Start with Chris Ro’s installation at Gallery SP, then stay nearby for a considered designer-vintage browse.', stops: [{ name: 'Chris Ro: Once Upon Now — Gallery SP', korean: '서울 용산구 회나무로44가길 30 1층 갤러리SP', note: 'Solo exhibition on time, memory and a 1997 house transformed through graphic design, painting, objects and installation. Today 10:00–18:00; arrive by 16:30.', booking: 'https://www.instagram.com/gallery__sp/' }, { name: 'Emulsion', korean: '서울 용산구 회나무로 48-10 에멀전', note: 'Closest designer-vintage stop: Loro Piana, Kiton, Armani, Burberry and Ralph Lauren; 12:00–20:00.', booking: 'https://www.emulsion.kr/' }], options: [{ name: 'ASYM', korean: '서울 용산구 이태원로14길 12 1층 아심', note: 'Tightly edited designer archive: Comme des Garçons, Yohji, Issey, Margiela and more; 13:00–20:00, closed Sun–Tue.', booking: 'https://www.instagram.com/asym_itaewon/' }, { name: 'Masterpiece Hannam', korean: '서울 용산구 이태원로 235 1층 마스터피스 한남', note: 'Japanese and American vintage / Americana; reported 13:00–20:00, then appointment-only.', booking: 'https://www.masterpiece-online.com/34' }, { name: 'Kien', korean: '서울 용산구 이태원로55가길 38 지하1층 키엔', note: 'Curated fashion-led second-hand in Hannam; reported 13:00–20:00.' }, { name: 'RPS Vintage', korean: '서울 용산구 녹사평대로40길 33 1층 알피에스 빈티지', note: 'Broader Noksapyeong/Itaewon vintage selection; reported 15:00–21:00, closed Monday.', booking: 'https://rockpaperscissorsvintage.kr/' }, { name: 'VASS Archive / Vintage', korean: '서울 마포구 독막로15길 3-18 1층 베이스', note: 'Existing Mapo archive-shopping option — use only if you want to cross town after Yongsan.' }] },
  { date: 'Aug 29', day: 'Sat · together', theme: 'Arrival, Gyeongbokgung & ANAM', description: 'Teresa arrives; keep the afternoon flexible, then settle into Seoul with a local dinner.', stops: [{ name: 'ANAM', korean: '서울 종로구 계동길 37 안암', note: 'Welcome dinner option', visited: true }], options: [{ name: 'Gyeongbokgung Palace', korean: '서울 종로구 사직로 161 경복궁', note: 'If arrival timing works: aim to arrive 16:15–16:45; last entry 17:30' }] },
  { date: 'Aug 30', day: 'Sun · together', theme: 'Seongsu: shopping, design & fashion', description: 'A full, loose shopping day for concept spaces, fashion, beauty and tea.', focus: '032c · tansanmagnesium · Gentle Monster · Tamburins · NUDAKE', stops: [{ name: 'Foreplan', korean: '서울 성동구 왕십리로14길 30-11 포플랜', note: 'Coffee / brunch' }, { name: '032c Gallery Seoul', korean: '서울 성동구 성수이로10길 14 032c 갤러리 서울', note: 'Gallery', visited: true }, { name: 'tansanmagnesium Flagship', korean: '서울 성동구 연무장길 37-26 탄산마그네슘', note: 'Climbing-inspired Korean streetwear flagship with a boulder-built entrance, café and retail over several floors; daily 11:00–21:00.', booking: 'https://tansanmagnesium.kr/', visited: true }, { name: 'HAUS NOWHERE Seoul — Gentle Monster, Tamburins + NUDAKE', korean: '서울 성동구 뚝섬로 433 하우스 노웨어 서울', note: 'Separate Seongsu flagship and experiential building for Gentle Monster, Tamburins and NUDAKE.', booking: 'https://www.gentlemonster.com/kr/en/stores', visited: true }] },
  { date: 'Aug 31', day: 'Mon · together', theme: 'Seogyo, Yeonnam, Hongdae & Hannam openings', description: 'A fuller local design-and-fashion day followed by two Frieze Week opening-night visits in Hannam.', focus: 'MMMG / D&DEPARTMENT · MUSINSA Standard · Kang Jae-gu · Friedrich Kunath · Koo Jeong A', stops: [{ name: 'D&DEPARTMENT SEOUL by MMMG — closed visit', korean: '서울 마포구 월드컵북로5길 41 1층 로컬스티치 크리에이터 타운 서교', note: 'Reached the shop but found it closed; a proper return visit is planned for September 5.', booking: 'https://www.d-department.com/ext/shop/seoul.html', visited: true }, { name: 'MUSINSA Standard Hongdae', korean: '서울 마포구 양화로 144 무신사 스탠다드 홍대', note: 'Contemporary Korean fashion browsing across B1–2F; open daily 11:00–21:00.', booking: 'https://locations.musinsa.com/en/stndhd', visited: true }, { name: 'KT&G Sangsangmadang Hongdae', korean: '서울 마포구 어울마당로 65 KT&G 상상마당 홍대', note: 'See Kang Jae-gu’s solo exhibition The Night Before Enlistment, plus the Character Park and Society of Ghosts design shows.', booking: 'https://www.sangsangmadang.com/main/HD', visited: true }, { name: 'Gyeongui Line Forest Park & Yeonnam shops', korean: '서울 마포구 연남동 경의선숲길', note: 'Follow the park north for independent-shop browsing and a coffee pause before dinner.', visited: true }, { name: 'Hangong-Gan', korean: '서울 마포구 연남동 561-4 한공간', note: 'Asian-fusion dinner; message them first to confirm a table.', booking: 'https://www.instagram.com/hangonggan/', visited: true }, { name: 'Pace Seoul opening — Friedrich Kunath: The Nearest Faraway Place', korean: '서울 용산구 이태원로 267 페이스 갤러리 서울', note: 'Visited the opening of Friedrich Kunath’s first Pace solo exhibition in Seoul: new paintings and drawings about distance, longing and relocation.', booking: 'https://www.pacegallery.com/exhibitions/friedrich-kunath-the-nearest-faraway-place/', visited: true }, { name: 'Leeum Museum of Art — Koo Jeong A: OUSSSMOS opening', korean: '서울 용산구 이태원로55길 60-16 리움미술관', note: 'Attended the opening of Koo Jeong A’s largest Korean museum exhibition, spanning phosphorescent, magnetic, scented and site-specific installations throughout Leeum.', booking: 'https://www.leeumhoam.org/leeum/exhibition/94?params=Y', visited: true }] },
  { date: 'Sep 1', day: 'Tue · together', theme: 'FUTURA, MMCA, piknic & Hongje', description: 'A full contemporary-art day spanning Jongno, Hoehyeon and Hongje.', focus: 'Es Devlin · Do Ho Suh · COMPANY', stops: [{ name: 'FUTURA SEOUL — Es Devlin: Come Home Again', korean: '서울 종로구 북촌로 61 푸투라서울', note: 'Immersive Es Devlin exhibition; open 10:00–18:00, last entry 17:30.', booking: 'https://www.futuraseoul.org/57', visited: true }, { name: 'MMCA Seoul — Do Ho Suh', korean: '서울 종로구 삼청로 30 국립현대미술관 서울', note: 'Do Ho Suh exhibition, running Aug 27, 2026–Feb 9, 2027.', booking: 'https://www.mmca.go.kr/eng/exhibitions/exhibitionsDetail.do?exhFlag=2', visited: true }, { name: 'piknic — COMPANY: World Affair', korean: '서울 중구 퇴계로6가길 30 피크닉', note: 'Visited the Helsinki studio COMPANY craft-and-design exhibition.', booking: 'https://english.visitseoul.net/exhibition/COMPANY-World-Affair/ENPqbvlpa', visited: true }, { name: 'Hongje Yuyeon — Yujin Complex', korean: '서울 서대문구 홍은동 48-84 유진상가 지하 홍제교', note: 'Free 250m underground light-and-sound art walk; allow 60–90 minutes. Open daily 10:00–22:00.', visited: true }] },
  { date: 'Sep 2', day: 'Wed · together', theme: 'Design Miami & Cheongdam Night', description: 'A focused indoor design visit followed by one cross-city subway journey to the self-guided Cheongdam Night circuit; the evening stops are then close together or connected by the free shuttle.', focus: 'Kwon Jung-mo · Niamh Barry · Teo Yang · Gyuhan Lee · LEJE · Marina Rheingantz · Generative Forms', focusLabel: 'Design / artist focus', stops: [{ name: 'Design Miami Seoul — recommended route', korean: '서울 중구 을지로 281 DDP 디자인랩 1층 디자인마이애미 서울', note: 'Recommended viewing order:\n• Arrive at 10:00 and allow 2–2½ hours.\n• Start with In Situ: Kwon Jung-mo’s illuminated hanok window, Niamh Barry’s sculptural lighting, Yuki Nara, Teo Yang, Lee Kyu-hong, Chun Woo-sung and Be Formative.\n• Continue to Side Gallery for Gyuhan Lee’s luminous paper works.\n• See Charles Burnand’s Memory of Materials, LEJE’s mother-of-pearl furniture, Studio MOTO and Vagujhelyi.\n• Finish with Samsung’s Design Is an Act of Love only if time remains.\n• Open until 20:00; last admission is 19:30.\n• The standard one-day ticket is sufficient for this visit.', booking: 'https://designmiami.com/fair/seoul-2026' }, { name: 'Gangnam Art Salon — Cheongdam Night starting hub', korean: '서울 강남구 도산대로45길 20 도산공원', note: 'Start here at 17:00. Pick up the English leaflet and a limited welcome kit, then follow the self-guided gallery circuit. There is no single group tour or registration point; the free shuttle runs 17:00–22:00.', booking: 'https://www.visitgangnam.net/en/events/2026-gangnam-art-festival', links: [{ label: 'English map & shuttle timetable ↗', url: 'https://www.visitgangnam.net/files/cheongdam-night-2026-en.pdf' }, { label: 'Neighbourhood Night details ↗', url: 'https://www.frieze.com/article/frieze-seoul-2026-neighbourhood-nights-celebrating-frieze-week' }] }, { name: 'White Cube Seoul — Marina Rheingantz: Míope', korean: '서울 강남구 도산대로45길 6 화이트 큐브 서울', note: 'Free public entry for Marina Rheingantz’s first Korean solo exhibition; extended hours 18:00–22:00.', booking: 'https://www.whitecube.com/locations/white-cube-seoul' }, { name: 'SONGEUN — Generative Forms', korean: '서울 강남구 도산대로 441 송은', note: 'Free public exhibition with extended hours to 22:00, a MINOTAURUS performance and an evening docent programme. Reserve the exhibition through Naver before going.', booking: 'https://booking.naver.com/booking/12/bizes/584682', links: [{ label: 'Cheongdam Night event details ↗', url: 'https://kiaf.org/en/events/61442' }] }], options: [{ name: 'Platform-L — PLAP 10 Party', korean: '서울 강남구 언주로133길 11 플랫폼엘 컨템포러리 아트센터', note: 'Optional only if you still have energy. The public drinks reception runs 17:00–21:00; the CodeSassy performance and artist talk require paid admission, discounted 50% during Cheongdam Night.', booking: 'https://www.visitgangnam.net/en/events/2026-gangnam-art-festival' }], must: 'Buy the standard Design Miami ticket and reserve SONGEUN. By public transport, allow about 45–55 minutes from DDP to the Dosan Park area; after that, walk or use the free event shuttle.' },
  { date: 'Sep 3', day: 'Thu · together', theme: 'Art books, Samcheong Night & Aapex', description: 'Begin at The Book Society, then stay on the east side of the palace for a compact gallery-night route before taking one subway-and-bus journey to Aapex in Yongsan.', focus: 'Independent publishing · Kim Bohie · Christine Sun Kim · Patricia Urquiola · Korean craft · audiovisual culture', focusLabel: 'Gallery-night focus', stops: [{ name: 'The Book Society Hoehyeon', korean: '서울 중구 퇴계로4길 2 로컬스티치 C동 3층 더북소사이어티', note: 'Independent art books, publishing and exhibitions; open Wednesday–Sunday 13:00–19:00.' }, { name: 'Gallery Hyundai — Samcheong Night', korean: '서울 종로구 삼청로 14 갤러리현대', note: 'Drinks reception for solo exhibitions by Kim Bohie and Christine Sun Kim; extended opening 16:00–23:00.', booking: 'https://www.frieze.com/article/frieze-seoul-2026-neighbourhood-nights-celebrating-frieze-week' }, { name: 'Cassina Store Seoul Samcheong', korean: '서울 종로구 북촌로5길 74 카시나 서울 삼청', note: 'See Patricia Urquiola’s Ardys and the Layered Stillness presentation by Huh Myoungwook, Jae Jung and Chung Sukyung; open 18:30–22:00.', booking: 'https://www.cassina.com/fr/fr/store-locator/cassina-store-seoul-samcheong-009505-1.html' }, { name: 'Aapex Bar', korean: '서울 용산구 한강대로21길 17-13 AAPEX BAR', note: 'Final late stop after Samcheong: industrial cocktail and cultural space with scent-led drinks, electronic music and audiovisual programming. Reported open until 01:00; check Instagram for the night’s programme.', booking: 'https://www.instagram.com/aapex_bar/' }], options: [{ name: 'Art Sonje Center — Samcheong Night Party', korean: '서울 종로구 율곡로3길 87 아트선재센터', note: 'Optional nearby party, 19:00–22:00. Registration is required and capacity is limited to 50, so include it only if you secure a place.', booking: 'https://kiaf.org/events/62667' }, { name: 'Soluna Fine Art — Material Bar', korean: '서울 종로구 효자로13길 46 솔루나 파인 아트', note: 'Optional west-of-palace alternative: cocktail reception centred on contemporary craft and material practice, 18:00–21:00. Pair it with Art Space 3 and skip the east-side Cassina route to avoid doubling back.', booking: 'https://www.solunafineart.com/' }, { name: 'Art Space 3 — Fi Jae Lee artist talk', korean: '서울 종로구 효자로7길 23 지하 1층 아트스페이스3', note: 'Optional west-of-palace alternative: artist talk and book presentation for Fi Jae Lee’s solo exhibition, 19:30–20:30.', booking: 'https://artspace3.com/' }], must: 'No Frieze ticket is needed. Allow roughly 30–40 minutes by public transport from Hoehyeon to Samcheong and 40–50 minutes from Samcheong to Aapex; the main gallery pair is walkable.' },
  { date: 'Sep 4', day: 'Fri · together', theme: 'Sinsa, Dosan & Cheongdam fashion', description: 'One concentrated designer-shopping corridor: start in Sinsa, continue through Dosan and finish east in Cheongdam, with no evening cross-city commitment.', focus: 'ADER error · Gentle Monster · Tamburins · NUDAKE · Yohji Yamamoto · CFCL · Guidi · KOLOR · Hed Mayner · JUUN.J · WE11DONE', stops: [{ name: 'ADER Space 3.0 Sinsa', korean: '서울 강남구 도산대로11길 31 아더 스페이스 3.0', note: 'Immersive ADER error flagship combining fashion, spatial design and installation-like interiors; open daily 11:00–21:00.', booking: 'https://www.adererror.com/' }, { name: 'HAUS NOWHERE Dosan', korean: '서울 강남구 압구정로46길 50 하우스 노웨어 도산', note: 'The original Dosan experiential flagship for Gentle Monster, Tamburins and NUDAKE; open daily 11:00–21:00. Keep this visit architecture-focused because you have already visited the larger Seongsu location.', booking: 'https://www.gentlemonster.com/kr/en/stores' }, { name: 'MECLADS Dosan', korean: '서울 강남구 도산대로49길 10-6 2층 맥클래즈', note: 'Multi-brand designer select shop with Yohji Yamamoto, CFCL, Guidi, KOLOR and Hed Mayner; opens at 13:00 on Fridays.', booking: 'https://m.meclads.com/shopinfo/company.html' }, { name: 'JUUN.J Dosan Flagship', korean: '서울 강남구 언주로164길 23 준지 도산 플래그십스토어', note: 'Korean designer flagship with a courtyard and sculptural interiors.', booking: 'https://designwanted.com/juun-j-flagship-wgnb/' }, { name: 'WE11DONE Cheongdam', korean: '서울 강남구 압구정로80길 24 웰던', note: 'Korean designer flagship; open daily 11:00–20:00.', booking: 'https://www.we11-done.com/us/service/store.php' }], options: [{ name: 'BEAKER Cheongdam Flagship', korean: '서울 강남구 압구정로 408 비이커 청담 플래그십', note: 'Optional multi-brand stop on the same eastbound route; a good fit only if the main five shops move quickly. Open daily around 11:00–20:00.' }, { name: 'House of Dior Seoul', korean: '서울 강남구 압구정로 464 하우스 오브 디올', note: 'Optional architecture and luxury browse near the Cheongdam finish.', booking: 'https://www.dior.com/fashion/stores/en_sg/south-korea/seoul/464-apgujeong-ro' }, { name: '10 Corso Como Cheongdam', korean: '서울 강남구 압구정로 416 10 꼬르소 꼬모', note: 'Optional fashion, books, design and café concept store; daily 11:00–20:00.', booking: 'https://10corsocomo.com/en-hk/blogs/stores/seoul-cheongdam' }], must: 'The five planned shops form one west-to-east corridor. Use local buses between clusters and skip the optional shops if you want a long lunch or extended fittings.' },
  { date: 'Sep 5', day: 'Sat · together', theme: 'Yeouido, Seogyo & Seongsu design', description: 'A balanced west-to-east design and fashion day: begin with Maison Margiela and SAN SAN GEAR inside The Hyundai, stop properly at D&DEPARTMENT, then finish with designer vintage and independent retail in Seongsu.', focus: 'Maison Margiela · SAN SAN GEAR · Korean design · designer vintage · LCDC Seoul', focusLabel: 'Fashion / design focus', stops: [{ name: 'Maison Margiela — The Hyundai Seoul', korean: '서울 영등포구 여의대로 108 더현대 서울 2층 메종 마르지엘라', note: 'Dedicated store visit for fashion, shoes, leather goods, accessories and fragrance; The Hyundai opens at 10:30 on Saturdays.', booking: 'https://www.maisonmargiela.com/stores/maison-margiela-the-hyundai-seoul' }, { name: 'SAN SAN GEAR — The Hyundai Seoul', korean: '서울 영등포구 여의대로 108 더현대 서울 지하 2층 산산기어', note: 'Technical Korean fashion store inside the same department store as Maison Margiela; find it on B2 Creative Ground. Friday–Sunday hours are 10:30–20:30.', booking: 'https://sansangear.com/pages/stores' }, { name: 'D&DEPARTMENT SEOUL by MMMG', korean: '서울 마포구 월드컵북로5길 41 1층 로컬스티치 크리에이터 타운 서교', note: 'Return for the visit missed when it was closed: Korean long-life design objects, stationery and food; open 11:30–19:00.', booking: 'https://www.d-department.com/ext/shop/seoul.html' }, { name: 'Fox Vintage Seoul Forest', korean: '서울 성동구 서울숲6길 10 지하1층 폭스빈티지 서울숲', note: 'Your dedicated vintage stop: a curated designer selection that often includes Comme des Garçons, Jil Sander, Vivienne Westwood and Missoni; reported open daily 13:00–21:00.', booking: 'https://seoul.vintagefox.kr/' }, { name: 'LCDC Seoul', korean: '서울 성동구 연무장17길 10 LCDC SEOUL', note: 'Multi-level design complex with a central courtyard, rotating Korean brands and curated design-object shops. Prioritize the architecture and changing independent retail; individual tenant hours vary.', booking: 'https://lcdc-seoul.com/' }], options: [{ name: 'Seoul Light DDP 2026 Autumn — Saturday live programme', korean: '서울 중구 을지로 281 동대문디자인플라자 서울라이트 DDP', note: 'Lower-priority optional finish only if you still have energy and the weather is comfortable. The free outdoor programme runs 19:30–22:30; SION performs 20:20–21:00 alongside the media façade and laser show.', booking: 'https://news.seoul.go.kr/culture/archives/534071' }], must: 'No booking is needed for the shops or Seoul Light. Maison Margiela and SAN SAN GEAR are in the same building. The route then has two longer public-transport legs—roughly 35–45 minutes from Yeouido to Seogyo and 50–60 minutes from Seogyo to Seongsu—followed by a short local transfer between Fox Vintage and LCDC.' },
...
const gallery27Seongsu: Stop = {
  name: 'Gallery27 Seongsu — Ki Kim',
  korean: '서울 성동구 동일로 27 2층 갤러리27',
  note: 'Contemporary-art gallery showing Ki Kim’s solo exhibition through 19 September. Open Tuesday–Friday 10:00–18:00; closed Sunday–Monday.',
  booking: 'https://gallery27ss.com/',
};
...
if (september3 && september4) {
  ...
  september4.stops = [gallery27Seongsu, potterySeongsu, twentyNineCmHome, pointOfViewSeoul, narrativeObject, bookSocietyHoehyeon, ...(aapex ? [aapex] : [])];
  september4.options = undefined;
  september4.theme = 'Seongsu shopping, art books & Aapex';
  september4.description = 'A westbound Friday: design and ceramics shopping around Seongsu, art books in Hoehyeon, then an Aapex nightcap in Yongsan.';
  september4.focus = 'Contemporary art · Korean design · ceramics · independent publishing · cocktails';
  september4.must = 'Start at Gallery27 when it opens at 10:00, then continue through the Seongsu shops: POTTERY, 29CM HOME from 11:00, then Point of View and Narrative Object from noon. After the Seongsu browse, take a taxi to The Book Society once it is open at 13:00, then continue to Aapex in the evening. Confirm Aapex’s live programme before going.';
}
...
if (september5) {
  ...
  september5.theme = 'Samcheong, Seochon & Insadong spa';
  september5.description = 'See the central galleries in a compact morning-and-lunch route, then keep the rest of the day free for a spontaneous massage, sauna and baths near home.';
  september5.focus = 'Contemporary art · wellness';
  september5.stops = [galleryHyundaiFriday, museumHanmiSamcheong, artSpaceThree, insadongSpa];
  september5.options = [
...
const itineraryDistricts: Record<string, string> = {
  ...
  'Gallery27 Seongsu — Ki Kim': 'Seongsu · Seongdong-gu',
...
const explore: ExploreStop[] = [
  ...
  { name: 'ANAM', korean: '서울 종로구 계동길 37 안암', note: 'Pork-and-rice-soup local meal', district: 'Jongno / Bukchon', category: 'Food & drinks', visited: true },
  ...
  { name: 'Aapex Bar', korean: '서울 용산구 한강대로21길 17-13 AAPEX BAR', note: 'Industrial cocktail and cultural space pairing scent-led drinks with electronic and audiovisual programming. Reported hours 18:30–01:00; closed Tuesdays. Check the night’s programme first.', district: 'Yongsan', category: 'Food & drinks', booking: 'https://www.instagram.com/aapex_bar/' },
  ...
  { name: 'Chilli — Local Stitch Hoehyeon', korean: '서울 중구 퇴계로4길 2 로컬스티치 회현 E동 1층 칠리', note: 'Casual food option inside Local Stitch Hoehyeon.', district: 'Jung / Euljiro', category: 'Food & drinks', booking: 'https://localstitch.kr/branch/place/26' },
  ...
  { name: 'Offline Body at dive.seoul', korean: '서울 광진구 천호대로 625 지하 다이브서울', note: 'Myungchan Kim’s 2024 photography exhibition — archived; check dive.seoul’s current programme before visiting', district: 'Gwangjin', category: 'Art & architecture', booking: 'https://www.instagram.com/dive.seoul/' },
  { name: 'Last Mors at CYLINDER ONE', korean: '서울 관악구 양녕로1길 48 실린더', note: 'Rim Park’s 2023–24 solo exhibition — archived; use it as a cue to check CYLINDER’s current programme', district: 'Gwanak', category: 'Art & architecture', booking: 'https://www.cylinderseoul.com/' },
  ...
  { name: 'FSW Coffee', korean: 'No. 2, Alley 14, Lane 150, Section 5, Xinyi Road, Xinyi District, Taipei 110, Taiwan', note: 'Phoebe Says Wow Architects’ coffee bar with a softly lit, translucent interior', district: 'Elsewhere / reference', category: 'Coffee & tea', booking: 'https://www.archdaily.com/974739/fsw-coffee-phoebe-says-wow-architects' },
  { name: 'KYOTOWAND Café', korean: '311-1 Kitatoryo-cho, Higashiyama-ku, Kyoto 605-0918, Japan', note: 'Kazuteru Matsumura Architects’ café and cultural refuge in a renovated machiya', district: 'Elsewhere / reference', category: 'Coffee & tea', booking: 'https://www.kyotowand.com/' },
  { name: 'Anbassa', korean: '57 bis Rue Hoche, 93500 Pantin, France', note: 'Office Abrami Rojas’ coffee roastery beneath a restored 1930s glass dome', district: 'Elsewhere / reference', category: 'Coffee & tea', booking: 'https://anbassa.fr/' },
  { name: 'ACID Café Berlin', korean: 'Rosenthaler Straße 9, 10119 Berlin, Germany', note: 'Plantea Studio’s bakery café, balancing raw concrete, red tiles and chestnut wood', district: 'Elsewhere / reference', category: 'Coffee & tea', booking: 'https://www.thisispaper.com/mag/acid-cafe-plantea-studio-berlin' },
  { name: '2050 Coffee', korean: '402 Sakurano-cho, Nakagyo-ku, Kyoto 604-8035, Japan', note: 'TEKI Design’s self-service café, built around the future and sustainability of coffee', district: 'Elsewhere / reference', category: 'Coffee & tea', booking: 'https://www.2050.coffee/' },
...
function readableParts(text: string, forceList = false) {
  const lines = text.split('\n').map((line) => line.trim()).filter(Boolean);
  if (lines.length > 1) {
    const hasIntro = !lines[0].startsWith('•');
    return { intro: hasIntro ? lines[0] : undefined, items: lines.slice(hasIntro ? 1 : 0).map((line) => line.replace(/^[•–-]\s*/, '')) };
  }
  const sentences = text.match(/[^.!?]+(?:[.!?]+|$)/g)?.map((sentence) => sentence.trim()).filter(Boolean) ?? [text];
  return forceList && sentences.length > 1 ? { items: sentences } : { intro: text, items: [] as string[] };
}

function ReadableCopy({ text, forceList = false }: { text: string; forceList?: boolean }) {
  const { intro, items } = readableParts(text, forceList || text.length > 160);
  return <div className="readable-copy">{intro && <p>{intro}</p>}{items.length > 0 && <ul>{items.map((item) => <li key={item}>{item}</li>)}</ul>}</div>;
}
...
export default function Home() {
  ...
  return <main>
    ...
    <nav className="filters" aria-label="Trip site navigation"><button className={tab === 'itinerary' ? 'selected' : ''} onClick={() => setTab('itinerary')}>Itinerary</button><button className={tab === 'explore' ? 'selected' : ''} onClick={() => setTab('explore')}>Explore</button><button className={tab === 'tips' ? 'selected' : ''} onClick={() => setTab('tips')}>Travel Tips</button></nav>
    {tab === 'itinerary' ? <>
      ...
      <section id="content" className="itinerary">
        <div className="section-head"><p className="eyebrow">The plan</p><h2>One beautiful district at a time.</h2><p>Stops are numbered in the order to do them. Tap a map button on your phone; it opens the location in your chosen Korean navigation service.</p></div>
        {shown.map((day) => <article className="day-card" data-trip-date={day.date} key={day.date + day.day}>
          <header><div><p className="date">{day.date}</p><p className="day">{day.day}</p></div><h3>{day.theme}</h3></header>
          <p className="description">{day.description}</p>
          {day.focus && <p className="focus"><span>{day.focusLabel ?? 'Fashion / artist focus'}</span>{day.focus}</p>}
          {day.must && <aside className="must"><span>Book / note</span><ReadableCopy text={day.must} forceList /></aside>}
          <div className="stops">{day.stops.map((stop, index) => <StopCard stop={stop} index={index + 1} key={stop.name} />)}</div>
